...
<script type="text/html" id="api-template">
  ...
  <div class="tab-content tab-content-styled">
    <div id="http-examples" class="tab-pane active">
      ...
      <table class="table table-bordered table-striped">
        <thead>
          ...
          <tbody>
            <tr>
              <td><a href="#docs/collections/reference/http.md#s-Listing Data-1286" >Listing data</a></td>
              <td>GET</td>
              <td><a href="<%- '/' + resourceData.id %>" ><%- '/' + resourceData.id %></a></td>
              <td><em>Nothing</em></td>
              <td>An array of objects</td>
            </tr>
            <tr>
              <td><a href="#docs/collections/reference/http.md#s-Creating an Object-1286" >Creating an object</a></td>
              <td>POST</td>
            ...
            <tr>
              <td><a href="#docs/collections/reference/http.md#s-Getting a Specific Object-1286" >Getting an object</a></td>
              <td>GET</td>
            ...
            <tr>
              <td><a href="#docs/collections/reference/http.md#s-Updating an Object-1286" >Updating an object</a></td>
              <td>PUT</td>
              <td><%- '/' + resourceData.id %>/&lt;id&gt;</td>
              <td>A single object</td>
              <td>The saved object (or errors)</td>
            ...
            <tr>
              <td><a href="#docs/collections/reference/http.md#s-Deleting an Object-1286" >Deleting an object</a></td>
              <td>DELETE</td>
              <td><%- '/' + resourceData.id %>/&lt;id&gt;</td>
              <td>A single object</td>
              <td><em>Nothing</em></td>
            ...
            <% if (resourceData.type === 'UserCollection') { %>
              <tr>
                <td><a href="#docs/users/authenticating-users.md#s-Logging in-2026" >Logging in</a></td>
                <td>POST</td>
              ...
              <tr>
                <td><a href="#docs/users/authenticating-users.md#s-Logging out" >Logging out</a></td>
                <td>POST</td>
              ...
              <tr>
                <td><a href="#docs/users/authenticating-users.md#s-Getting the current user" >Getting the current user</a></td>
                <td>GET</td>
                <td><a href="<%- '/' + resourceData.id %>/me" ><%- '/' + resourceData.id %>/me</a></td>
                <td><em>Nothing</em></td>
                <td>A single object</td>
              </tr>
            <% } %>
    ...
    <p>Deployd generates a <a href="#docs/collections/reference/dpd-js.md">browser JavaScript API</a> for easily accessing data from the <code><%= '/' + resourceData.id %></code> collection. To use it you first need to include the generated script.</p>
...
dpd<%= ns('/' + resourceData.id) %>.get(function (result, err) {
  ...
  console.log(result);
    ...
    <p>Get all the objects in the <code><%= '/' + resourceData.id %></code> collection that match a query:</p>
    <pre class="code prettyprint">
var query = <%= getObj() %>;
...
dpd<%= ns('/' + resourceData.id) %>.get(query, function (result) {
  console.log(result);
    ...
    <pre class="code prettyprint">
dpd<%= ns('/' + resourceData.id) %>.get("000000000000000000000000", function (result) {
  console.log(result);
});</pre>
